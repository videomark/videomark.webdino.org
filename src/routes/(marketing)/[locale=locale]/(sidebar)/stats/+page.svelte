...
<MetaTags meta={$json('pages.stats.meta')} />

<Header>
  <h1>{$_('pages.stats.intro.heading')}</h1>
  {@html parse($_('pages.stats.intro.body'))}
</Header>
...
<Section>
  <h2>{$_('pages.stats.opendata.heading')}</h2>
  {@html parse($_('pages.stats.opendata.body'))}
</Section>
