<script>
  ...
  import LegalDocHistory from '$lib/components/marketing/legal-doc-history.svelte';
...
<LegalDocHistory
  title={$_('pages.terms.history.heading')}
  changes={unique(/** @type {object[]} */ ($json('pages.terms.history.changes')), 'date')}
/>
